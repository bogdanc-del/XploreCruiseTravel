        ...
        <div className="grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-5 flex gap-3">
              {[
                { platform: 'facebook', url: 'https://www.facebook.com/xplorecruisetravel', labelRo: 'Pagina noastră de Facebook', labelEn: 'Our Facebook page' },
                { platform: 'instagram', url: 'https://www.instagram.com/xplorecruisetravel', labelRo: 'Pagina noastră de Instagram', labelEn: 'Our Instagram page' },
                { platform: 'tiktok', url: 'https://www.tiktok.com/@xplorecruise', labelRo: 'Pagina noastră de TikTok', labelEn: 'Our TikTok page' },
                { platform: 'twitter', url: 'https://x.com/xplorecruise', labelRo: 'Pagina noastră de X', labelEn: 'Our X page' },
...
function SocialIcon({ platform }: { platform: string }) {
  ...
  switch (platform) {
    ...
    case 'tiktok':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
          <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1v-3.51a6.37 6.37 0 0 0-.79-.05A6.34 6.34 0 0 0 3.15 15.17a6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V9.17a8.16 8.16 0 0 0 4.76 1.52v-3.4a4.85 4.85 0 0 1-1-.6z" />
        </svg>
      )
    case 'twitter':
      return (
